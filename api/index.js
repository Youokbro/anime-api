...
const PROVIDERS = ['AnimePahe', 'AnimeKai', 'KickAssAnime', 'AnimeUnity', 'AnimeSaturn']
...
app.get('/watch', async (req, res) => {
  try {
    ...
    const REF_MAP = { AnimeSaturn: 'https://www.animesaturn.cx', AnimeUnity: 'https://www.animeunity.to', AnimePahe: 'https://animepahe.ru', AnimeKai: 'https://animekai.to', KickAssAnime: 'https://kickassanime.am' }
